 ...
 */
export function paginated<T>(c: Context, data: T[], pagination: { hasMore: boolean; nextCursor?: string }) {
 ...
 */
export function error(c: Context, message: string, status: 400 | 401 | 403 | 404 | 500 = 400, details?: unknown) {
