...
describe('Frontend Utils', () => {
  describe('formatAmount', () => {
    ...
    let formatAmount: (amount: number) => string;

    beforeEach(async () => {
      const mod = await import('../../apps/web/app/utils');
      formatAmount = mod.formatAmount;
    });
  ...
  describe('debounce', () => {
    let debounce: <T extends (...args: unknown[]) => unknown>(fn: T, delay: number) => (...args: Parameters<T>) => void;
