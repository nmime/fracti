...
test.describe('Expenses Page', () => {
  ...
  test('should create new expense', async ({ page }) => {
    ...
    if (await addButton.isVisible()) {
      ...
      const descriptionInput = page
        .locator('input[name="description"], input[placeholder*="description" i], textarea')
        .first();
  ...
  test('should filter expenses by date', async ({ page }) => {
    ...
    const dateFilter = page
      .locator('input[type="date"], [data-testid="date-filter"], button:has-text("Filter")')
      .first();
...
test.describe('Expense Interactions', () => {
  ...
  test('should delete expense with confirmation', async ({ page }) => {
    ...
    const deleteButton = page
      .locator('[aria-label*="delete" i], button:has-text("Delete"), [data-testid="delete-expense"]')
      .first();
  ...
  test('should edit existing expense', async ({ page }) => {
    ...
    const editButton = page
      .locator('[aria-label*="edit" i], button:has-text("Edit"), [data-testid="edit-expense"]')
      .first();
